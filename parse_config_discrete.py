...
INPUT = "discrete/discrete-exp.txt"
OUTPUT_CONFIG   = "discrete/config.csv"
OUTPUT_ABSOLUTE   = "discrete/absolute.csv"
OUTPUT_EVALUATOR  = "discrete/evaluator.csv"
OUTPUT_ACTOR      = "discrete/actor.csv"
OUTPUT_TRAINER    = "discrete/trainer.csv"
...
TRAINER_SCALAR_MAP = {
    ...
    "Loss dual":            "loss_dual",
    "Loss kl penalty":      "loss_kl_penalty",
